...
eval $HOME"/v94_executables/change_static_param_qlook" $1 $2 $3 $ch1 $ch2 $ch3 $ch4 $ch5 $ch6 $ch7 $ch8 $ch9 $ch10 $ch11 $ch12 $ch13 $ch14 $ch15 $ch16 $ch17 $ch18 $ch19 $ch20 $ch21 $ch22 $ch23 $ch24
exit
